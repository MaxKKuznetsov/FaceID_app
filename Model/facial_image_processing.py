...
class FrameProcessing:
    ...
    def __init__(self, frame):
        ...
        self.detect_face_FaceRecognition()
        self.faces = self.face_FaceRecognition2face_MTCNN()

        # there is at least one face bigger then 5000pix
        self.face_size_flag = self.face_size_test(self.faces, self.min_face_size)

        self.faces = self.fase_size_calc(self.faces)

        face_label = 'FaceRec'
        self.faces = self.add_face_label(self.faces, face_label)
    ...
    def face_FaceRecognition2face_MTCNN(self):
        '''
    ...
    def frame_quality_aware(self):
        ...
        if self.faces:
            ...
            for k in range(len(self.faces)):
                ...
                self.faces[k]['contrast'], self.faces[k]['brightness'], self.faces[k][
                    'focus'] = contrast, brightness, varianceOfLaplacian
