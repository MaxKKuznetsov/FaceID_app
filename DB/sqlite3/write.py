#see https://www.pythonforthelab.com/blog/storing-data-with-sqlite/ !!!
...
#array1 = json.dumps(array_in1) #no
#array1 = array_in1.tobytes() #no
...
#array1 = np.array2string(array_in1) #ok
...
array1 = np.array2string(array_in1)
array2 = np.array2string(array_in2)
print(type(array1))
print(array1)
